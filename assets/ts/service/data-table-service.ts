...
export class DataTableService
{
    ...
    initTable()
    {
        let tableOptions = this.getTableOptions();
        // @ts-ignore
        $('#' + this._tableId).DataTable(tableOptions);
    }
    ...
    getTableOptions() {
        ...
        return {
            ...
            rowCallback: (row: string, data: DataTableItem) =>
            {
    ...
    renewTableView() {
        ...
        columns.push({title: 'Doubling rate of cases in days', data: 'doublingTotalRate', className: 'column', render: columnCallbackFixedNumber, createdCell: cellCallbackDoublingTotal});
